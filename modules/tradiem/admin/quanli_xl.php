...
$page_title = $lang_module['quanli_xl'];
	...
	$contents .= "<tfoot><tr><td colspan='10'><span class=\"btn btn-primary\"><a class='khoitao' href=\"index.php?" . NV_NAME_VARIABLE . "=" . $module_data . "&" . NV_OP_VARIABLE . "=khoitaoxl&amp;lopid=" . $lopid . "&amp;manamhoc=" . $manamhoc . "&amp;mahocky=" . $mahocky . "\">" . $lang_module ['khoitao'] . "</a></span></td></tr></tfoot>";
	$contents .= "</table>\n";
