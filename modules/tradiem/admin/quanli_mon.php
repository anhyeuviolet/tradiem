...
$query = $db->query ( "SELECT monid FROM " . NV_PREFIXLANG . "_" . $module_data . "_monhoc" );
...
$contents .= "<tfoot><tr><td colspan='6'><span class=\"btn btn-primary\"><a class='add' href=\"index.php?" . NV_NAME_VARIABLE . "=" . $module_data . "&" . NV_OP_VARIABLE . "=addmon\">" . $lang_global ['add'] . "</a></span></td></tr></tfoot>";
$contents .= "</table>\n";
