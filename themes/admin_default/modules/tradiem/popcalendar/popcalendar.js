...
var popCalendar = {
  ...
  init: function(installEventHandlers) {
    ...
    with (c) { type = 'text/css'; rel = 'stylesheet'; href = nv_siteroot + nv_base_siteurl + 'themes/admin_default/modules/' + nv_module_name + '/popcalendar/calendar_themes/' + this.theme+'/style.css'; media = 'screen'; }
